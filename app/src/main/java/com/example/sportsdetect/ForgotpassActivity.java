...
import com.example.sportsdetect.R;
    ...
    private void resetPassword(String temail) {
        ...
        authProfile.sendPasswordResetEmail(temail).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                {
                    Toast.makeText(ForgotpassActivity.this, "Please check your email inbox for password reset link",
                            Toast.LENGTH_LONG).show();
                    Intent intent=new Intent(ForgotpassActivity.this, com.example.sportsdetect.LoginActivity.class);
